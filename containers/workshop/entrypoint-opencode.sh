...
# Forces OpenCode to use "sudo -u poc" for all PoC operations.
...
# --- Auth isolation: restrict OpenCode config from poc user ---
# ~/.local/share/opencode is mounted directly; restrict permissions so poc cannot read credentials.
chmod 700 /home/node/.local/share/opencode 2>/dev/null || true
chmod 700 /home/node/.config/opencode 2>/dev/null || true
