...
Create `plugins/offline-research/skills/refactor-probe/SKILL.md`. This is faithfully adapted from the source at `~/Development/offline-research/skills/refactor-probe/SKILL.md` with these changes only:
...
Copy from source `~/Development/offline-research/templates/refactor-probe/prompt.md` with these changes:
...
Copy from source `~/Development/offline-research/templates/refactor-probe/progress.md` verbatim.

- [ ] **Step 3: Create expansion-loop.md**

Copy from source `~/Development/offline-research/templates/refactor-probe/expansion-loop.md` verbatim. The `[PROBE_DIR]` and `[DIMENSION_HINTS]` placeholders are filled by the skill.

- [ ] **Step 4: Create scoring-rubric-template.md**

Copy from source `~/Development/offline-research/templates/refactor-probe/scoring-rubric-template.md` verbatim.
